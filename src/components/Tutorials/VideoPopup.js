...
function SimpleDialog(props) {
  ...
  return (
    <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open} className="h-stepper-video-pop">
    	<>
      	<iframe title="popupvideo" width="600" height="385" src={props.link} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </>
    </Dialog>
  );
}
